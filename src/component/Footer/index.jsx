    ...
    <div>
      <footer>
        <div className="row">
          ...
          <div className="col-sm">
            <p className="font-weight-bold mt-2 font-footer1">Wetick</p>
          ...
          <div className="col-sm">
            <p className="font-weight-bold mt-2 font-footer1">Feature</p>
            <div className="d-flex flex-column">
              <a
                href="#"
                className="text-decoration-none text-muted font-footer2 ms-1"
          ...
          <div className="col-sm">
            <p className="font-weight-bold mt-2 font-footer1">Company</p>
            <div className="d-flex flex-column">
              <a
                href="#"
                className="text-decoration-none text-muted font-footer2 ms-1"
        ...
        <p className="font-weight-bold">© 2020 Wetick All Right Reserved</p>
      </footer>
    </div>
  );
}
